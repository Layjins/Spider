...
datasets = dict(
    train=dict(
        ...
        i2t_cc_sbu=dict(batch_size=1, sample_ratio=20,
                    build_info=dict(webdataset_path='/root/autodl-tmp/4e5ee6e154984712803fe75176fe7a38/cc_sbu/cc_sbu_dataset/{00000..01255}.tar')),
        ...
        a2t_audiocap=dict(batch_size=1, sample_ratio=20,
                    build_info=dict(audio_dir='/root/autodl-tmp/4e5ee6e154984712803fe75176fe7a38/AudioCaps/dataset/train',
                                    ann_path='/root/autodl-tmp/4e5ee6e154984712803fe75176fe7a38/AudioCaps/train.json')),
        ## T-to-X ##
        ...
        travel_guide=dict(batch_size=1, sample_ratio=20,
                      build_info=dict(json_path='/root/autodl-tmp/4e5ee6e154984712803fe75176fe7a38/travel_guide.json')),
    ...
    val=dict(
        # it2b_refcoco=dict(batch_size=1,
        #               build_info=dict(image_path='/root/autodl-tmp/4e5ee6e154984712803fe75176fe7a38/COCO2014/train2014',
        #                               ann_path='/root/autodl-tmp/4e5ee6e154984712803fe75176fe7a38/Referring_Expression',
        #                               dataset='refcoco',
        #                               splitBy='unc')),
...
run = dict(
    ...
    seed=41,
    output_dir="/jinxianglai/exp/spider/stage4",
    amp=True,
