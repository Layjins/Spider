...
class T2ATsAudioCapDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        question = instruction_q.format(caption)
...
@registry.register_builder("t2a_ts_audiocap")
class T2ATsAudioCapBuilder:
    train_dataset_cls = T2ATsAudioCapDataset

    def __init__(self, cfg=None):
        self.config = cfg

    def build_datasets(self):
        logging.info("Building T2ATsAudioCap datasets...")
