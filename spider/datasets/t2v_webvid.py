...
class T2VWebVid:
    def __init__(self, webdataset_path):
        ...
        self.instruction_pool = [
            "{}",
            "Generate {}",
            "Please generate an video based on the following text: {}",
            "Could you create an video from this text: {}",
            "I would like you to generate an video based on this text: {}",
            "Please create an video from the following text: {}",
            "Could you generate an video based on this text: {}",
            "I need your help in creating an video from this text: {}",
            "Please create an video from the following text: {}",
            "I would like you to create an video from this text: {}",
        ]
    ...
    def to_dict(self, sample):
        ...
        # answer = "<VIDEO><VIDEO-Placeholder></VIDEO>"
        # answer = "<VIDEO><VIDEO-Placeholder></VIDEO> {} ".format(sample[1])
        answer = "<VIDEO>{}<VIDEO-Placeholder></VIDEO>".format(sample[1])
...
@registry.register_builder("t2v_webvid")
class T2VWebVidBuilder:
    train_dataset_cls = T2VWebVid

    def __init__(self, cfg=None):
        self.config = cfg

    def build_datasets(self):
        logging.info("Building T2VWebVid datasets...")
