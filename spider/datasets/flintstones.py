...
class FlintstonesDataset(Dataset):
    ...
    def __init__(self, h5_path, subset):
        super(FlintstonesDataset, self).__init__()
...
@registry.register_builder("flintstones")
class FlintstonesBuilder:
    train_dataset_cls = FlintstonesDataset

    def __init__(self, cfg=None):
        self.config = cfg

    def build_datasets(self):
        logging.info("Building Flintstones datasets...")
