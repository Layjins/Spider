...
class A2TAudioCapDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        question = "<AUDIO><AUDIO-Placeholder></AUDIO> {} ".format(instruction)
...
@registry.register_builder("a2t_audiocap")
class A2TAudioCapBuilder:
    train_dataset_cls = A2TAudioCapDataset

    def __init__(self, cfg=None):
        self.config = cfg

    def build_datasets(self):
        logging.info("Building A2TAudioCap datasets...")
