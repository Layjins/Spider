...
class V2TWebVid:
    ...
    def to_dict(self, sample):
        ...
        question = "<VIDEO><VIDEO-Placeholder></VIDEO> {} ".format(instruction)
...
@registry.register_builder("v2t_webvid")
class V2TWebVidBuilder:
    train_dataset_cls = V2TWebVid

    def __init__(self, cfg=None):
        self.config = cfg

    def build_datasets(self):
        logging.info("Building V2TWebVid datasets...")
